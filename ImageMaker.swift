...
protocol ImageMakerDelegate:NSObjectProtocol{
    func _imageMaker_canceled()
    func _imageMaker_saved()
}


class ImageMaker:UIViewController,UIImagePickerControllerDelegate,UINavigationControllerDelegate {
